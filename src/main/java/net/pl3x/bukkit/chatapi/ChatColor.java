...
/**
 * Simplistic enumeration of all supported color values for api.
 */
public enum ChatColor {
    ...
    ITALIC('o', "italic"),
    /**
     * Resets all previous api colors or formats.
     */
    RESET('r', "reset");
    /**
     * The special character which prefixes all api colour codes. Use this if
